    ...
    useEffect(() => {
        ...
        const patchEmbeds = (el: HTMLElement, filePath: string, depth: number) => {
            ...
            [...el.findAll('.internal-embed')].forEach(async (el) => {
                ...
                const target = typeof src === 'string' && plugin.app.metadataCache.getFirstLinkpathDest(src, filePath);
                if (target instanceof TFile) {
                    ...
                    switch (target.extension) {
                        case 'md':
                            ...
                            previewEl = el.getElementsByClassName('markdown-preview-view')[0] as HTMLElement;
